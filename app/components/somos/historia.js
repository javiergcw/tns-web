                ...
                <div className="flex flex-col md:flex-row max-w-6xl mx-auto items-center">
                    <div className="md:w-1/2 text-center md:text-left px-4">
                        ...
                        <p className="text-[14px]">
                            ...
                            que
                            moldeaba una propuesta nueva de educación.
                            <br></br>
                            ...
                            compartiendo con el Colegio sus conocimientos domino los espacios de maduración del
                            proyecto.
                            <br></br>
                            ...
                            consecuencia
                            enseñar a dar de lo que se tiene se convirtió en un reto para la formación de los
                            estudiantes.
                        </p>
                    </div>
