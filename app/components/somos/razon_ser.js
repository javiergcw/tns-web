    ...
    return (
        <div className="backgroundImage">
            ...
            <div className="contenedor flex justify-center items-center min-h-screen z-10">
                <div className="flex flex-col md:flex-row max-w-6xl mx-auto md:mt-[-250px] px-4 md:px-0">
                    {/* Contenido de la izquierda */}
                    <div className="md:w-1/2 flex justify-center md:justify-start py-4">
                        <img
                            className="rounded-full border-4 border-gray-200 mt-5 md:mt-5 md:ml-2 max-w-full md:w-[600px] md:h-[572px]"
                    ...
                    <div className="md:w-1/2 mt-4 md:mt-0 md:pl-8 mb-[128px]">
                        <strong><h1 className="text-center text-[#1e73be] md:text-center mb-20">Nuestra Razón de Ser</h1></strong>
                        <p className="md:text-[12px] text-justify">
